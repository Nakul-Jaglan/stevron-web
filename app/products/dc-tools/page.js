      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10 py-20 px-8">
          ...
          >
            ...
            >
              DC <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Tools</span>
            </motion.h1>
            <motion.p 
            ...
            >
              Discover our premium collection of professional-grade DC tools designed for precision and reliability
            </motion.p>
          </motion.div>
        </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative w-full mb-6 rounded-2xl overflow-hidden ">
                      <img
                        src={imageErrors[product.code] ? "/square/p2.png" : product.image}
                        alt={product.name}
                        // fill
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div className="relative w-full rounded-2xl overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900">
                    <img
                      src={imageErrors[selectedProduct.code] ? "/square/p2.png" : selectedProduct.image}
          ...
          >
            ...
            >
              ...
              >
                ...
                <input type="hidden" name="_subject" value="New Quote Request from DC Tools Page" />
