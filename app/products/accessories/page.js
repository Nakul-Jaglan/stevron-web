  ...
  return (
    <BgLayout modalOpen={!!selectedProduct}>
      <div className="min-h-screen relative overflow-hidden">
        {/* <div>
          <img src="/banner/hardware-banner.png" alt="Banner" className="w-full mt-25" />
        </div> */}
        ...
        <div className="relative z-10 py-20 px-8">
          ...
          >
            ...
            >
              Acces<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">sories</span>
            </motion.h1>
            <motion.p 
            ...
            >
              Discover our premium collection of professional-grade Accessories designed for precision and reliability
            </motion.p>
          </motion.div>
        </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative w-full mb-6 rounded-2xl overflow-hidden ">
                      <img
                        src={imageErrors[product.code] ? "/square/p6.png" : product.image}
                        alt={product.name}
                        // fill
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div className="relative w-full rounded-2xl overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900">
                    <img
                      src={imageErrors[selectedProduct.code] ? "/square/p6.png" : selectedProduct.image}
                  ...
                  <div className="flex gap-6">
                    <motion.button
                      ...
                      className="flex-1 text-2xl  bg-gradient-to-r from-[#989b2e] to-[#b8bb32] text-white font-semibold py-4 px-2 rounded-xl hover:from-[#8a8d29] hover:to-[#a6a92e] transition-all duration-200 cursor-pointer shadow-lg hover:shadow-xl"
                    >
                      Get a Quote
                    </motion.button>
          ...
          >
            ...
            >
              ...
              >
                ...
                <input type="hidden" name="_subject" value="New Quote Request from Accessories Page" />
