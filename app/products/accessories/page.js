                ...
                >
                  ...
                  >
                    ...
                    <div className="relative w-full mb-4 sm:mb-6 rounded-2xl overflow-hidden">
                      <img
                        src={imageErrors[product.code] ? "/accessories/BWCB125M.webp" : product.image}
                        alt={product.name}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="relative w-full h-64 sm:h-90 md:h-96 rounded-2xl overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900">
                    <img
                      src={imageErrors[selectedProduct.code] ? "/accessories/BWCB125M.webp" : selectedProduct.image}
          ...
          >
            ...
            >
              ...
              >
                ...
                <input type="hidden" name="_subject" value="New Quote Request from Accessories Tools Page" />
